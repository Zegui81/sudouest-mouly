...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 14 fév. 2018 à 14:50
...
--
-- Base de données :  `monbonterroir`
--
CREATE DATABASE IF NOT EXISTS `monbonterroir` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `monbonterroir`;
...
(3, 'Tariquet Première Grives', 8.9, 0.5, 2, 'Ce vin Premières Grives est à l\'origine du succès et de la notoriété des vins du domaine de Tariquet.Les raisins sont récoltés à l\'automne, ils sont alors arrivés à grande maturité, et sont donc très sucrés.', 'boisson', 1),
