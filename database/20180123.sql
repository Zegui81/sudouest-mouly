...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 23 jan. 2018 à 22:42
...
(26, 'Coffret gastronomique', 29.5, 0, 10, 'Foie gras, champagne, perles de saveur, truffes et biscuits roses pour un coffret cadeau tout en raffinement pour les amateurs de gastronomie.', 'plat', 0),
...
(29, 'Foie gras de canard', 5.7, 0, 10, 'Composé d\'un mélange de plusieurs foies gras finement hachés et assaisonnés, ses saveurs sont authentiques. Son aspect lisse permet de réaliser des tranches régulières pour une présentation parfaite sur toasts en entrée ou à l\'apéritif.', 'plat', 0),
...
--
ALTER TABLE `produit`
  ADD CONSTRAINT `fk_produit_categorie` FOREIGN KEY (`categorie`) REFERENCES `categorie` (`code`) ON UPDATE CASCADE ON DELETE CASCADE;
COMMIT;
