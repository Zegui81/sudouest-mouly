<div class="white">
	<div class="produit">
		...
		<div class="conteneur-center">
    		<form class="liste-item-inscription item-admin gestion-user-admin-info" enctype="multipart/form-data" onsubmit="return validateUpdateProduit()" name="adminUser" method="POST" action="action/doUpdateUser.php">
               ...
               <div class="admin-item-droit">
    	           ...
    	           <input type="text" name="prenom" placeholder="prénom" class="input-inscription remove-error" value="<?php echo $user->getPrenom() ?>"><br/>
               </div>    	        
               <div class="admin-item-gauche">
    	           <span class="lbl-admin-produit lbl-marge-droite-input">Adresse :</span>
    	           <input type="text" name="adresse" placeholder="adresse" class="input-inscription remove-error" value="<?php echo $user->getAdresse() ?>"><br/>
    	           <span class="lbl-admin-produit lbl-marge-droite-input">CP :</span>
    	           <input type="text" name="codePostal" placeholder="code postal" class="input-inscription remove-error" value="<?php echo $user->getCodePostal() ?>"><br/>
    	           <span class="lbl-admin-produit lbl-marge-droite-input">Ville :</span>
    	           <input type="text" name="ville" placeholder="ville" class="input-inscription remove-error" value="<?php echo $user->getVille() ?>"><br/>
    	           <span class="lbl-admin-produit lbl-marge-droite-input">Naissance:</span>
    	           <input type="date" name="naissance" placeholder="naissance" class="input-inscription remove-error" value="<?php echo $user->getNaissance() ?>"><br/>
               </div>
               <div class="admin-item-droit">
